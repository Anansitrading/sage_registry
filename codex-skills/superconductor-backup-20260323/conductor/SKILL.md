---
name: conductor
description: Context-driven development framework that transforms the agent into a proactive project manager. Manages intent alignment, specs, plans, and implementation tracks with commands like /conductor:setup, /conductor:superconductor, /conductor:newTrack, /conductor:implement, /conductor:review, /conductor:status, and /conductor:revert. Use when user asks to set up conductor, run brownfield intake, create feature tracks, implement plans, review completed work, or manage project workflows. Integrates with architect, curiosity, scrum, NotebookLM, and dependency-graph/code-graph skills for aligned execution.
metadata:
  author: DavidSkills
  version: '4.0'
---
